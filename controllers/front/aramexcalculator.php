...
class AramexshippingAramexcalculatorModuleFrontController extends ModuleFrontController
{
    private $model;
    ...
    public function init()
    {
        ...
        include_once _PS_MODULE_DIR_ . 'aramexshipping/classes/core/AramexAramexcalculatorMethodModel.php';
        $this->model = new AramexAramexcalculatorMethodModel();
    }
    ...
    public function initContent()
    {
        if ($this->ajax) {
            ...
            $address['product_id'] = Tools::getValue('product_id') ? Tools::getValue('product_id') : "";
            $address['currency'] = Tools::getValue('currency') ? Tools::getValue('currency') : "";
            $this->model->calculateRate($address);
        }
    }
}
